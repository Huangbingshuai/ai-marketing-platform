...
import { EFFECT_DELIVERY_CHANNELS, EFFECT_STYLE_TONES } from './effect-video-settings';
...
/** @deprecated Use EFFECT_STYLE_TONES. */
export const EFFECT_IMPORT_STYLE_TONES = EFFECT_STYLE_TONES;
/** @deprecated Use EFFECT_DELIVERY_CHANNELS. */
export const EFFECT_IMPORT_DELIVERY_CHANNELS = EFFECT_DELIVERY_CHANNELS;
